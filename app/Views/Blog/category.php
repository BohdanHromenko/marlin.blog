...
<div class="post-pagination  clearfix">
    <ul class="pagination text-left">
        ...
        <li <?php if ($i == $numberOfPages) echo "class='active'"; if($amountPages == 1) echo "style='display:none;'";?>><a href="/category/<?=$slug?>/<?=$i?>"><?=$i?></a></li>
        <?php endfor; ?>
        <li <?php if($amountPages == $numberOfPages || $amountPages == 1) echo "style='display:none;'";?>><a href="/category/<?=$slug?>/<?=$numberOfPages+1?>"><i class="fa fa-angle-double-right"></i></a></li>
    </ul>
</div>
