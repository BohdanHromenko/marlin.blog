<?php $this->layout('layoutAdmin', ['title' => 'List category']); ?>
                    ...
                    <div class="box-body">
                        <div class="">
                            <div class="box-header">
                                <h2 class="box-title">All category</h2>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <?php if ($status == 1): ?>
                                <a href="/admin/category/create" class="btn btn-success btn-lg">Add Category</a> <br> <br>
                                <?php endif; ?>
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($status == 1): ?>
                                            <a href="/admin/category/edit/<?=$item['id']?>" class="btn btn-warning">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="/admin/category/delete/<?=$item['id']?>" class="btn btn-danger" onclick="return confirm('Вы уверены?');">
